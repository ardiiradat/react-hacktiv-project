...
export class AboutMeetUp extends React.Component {
  constructor() {
    super();
    this.state = {
      titleAboutMeetup: "About Meetup"
    };
  }
  render() {
    return (
      <React.Fragment>
        <div className="row mt-5 ">
          <div className="col-md-12 about-meetup">
            <h2>{this.state.titleAboutMeetup}</h2>
          </div>
          <div className="col-md-12 content-about-meetup">
